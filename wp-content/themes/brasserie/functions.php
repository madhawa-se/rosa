...
include (get_template_directory().'/inc/theam_custamizer.php');
/**
...
function brasserie_scripts() {
	...
	if (is_page_template( 'page-templates/custom_home.php' )) {
		...
		//madhawa
		wp_enqueue_script('mad', get_template_directory_uri().'/js/mad.js',false,1.0,false);
...
/*custom functions written by madhawa priyashantha*/


add_action('customize_register','md_custimize_register');
